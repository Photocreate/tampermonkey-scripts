...
test('buildSearchURLByOrderNum', () => {
    const pcTM = new PCTamperMonkey();
    expect(pcTM.buildSearchURLByOrderNum("12345678")).toBe("https://admin-app.photocreate.jp/adm/?action_support_order_detail=true&action_support_order_num=12345678#result");
});
test('buildSearchURLByPhotoNum', () => {
    const pcTM = new PCTamperMonkey();
    expect(pcTM.buildSearchURLByOrderNum("1234-5678")).toBe("https://admin-app.photocreate.jp/adm/?action_support_order_detail=true&action_support_order_num=1234-5678#result");
});
